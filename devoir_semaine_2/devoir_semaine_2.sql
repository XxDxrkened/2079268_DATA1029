...
-- Ecercice 6: À partir de la table « titles », obtenir la liste des titres ne débutant ni par S, ni par B, mais dont la 3ème lettre est « f ». Afficher le titre et le prix.
